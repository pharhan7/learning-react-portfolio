...
const Data = () => {
  return (
    <div className="home_data">
        ...
        <h4 className="home_subtitle">Backend Developer,  DevOps Engineer</h4>
        <p className='home_discription'>I've experience in Nodejs Express, developing and maintaining Backend Optmaizing code and Api Optimization, AWS EC2, Route 53, S3 buccket, SSL ... etc </p>
