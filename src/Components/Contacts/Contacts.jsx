            ...
            <div className="contact__content">
                ...
                <div className="contact__info">
                    <div className="contact__card">
                        ...
                        <span className="contact__card-data">developerfarhan7@gmail.com</span>

                        <a href="mailto:developerfarhan7@gmail.com" className="contact__button">
                    ...
                    <div className="contact__card">
                        ...
                        <span className="contact__card-data">farhansaifi</span>

                        <a href="https://www.linkedin.com/in/farhansaifi" className="contact__button" target='_blank'>
                            Find me {" "}<i className="bx bx-right-arrow-alt contact__button-icon"></i>
                        </a>
                    </div>
                </div>
            </div>
